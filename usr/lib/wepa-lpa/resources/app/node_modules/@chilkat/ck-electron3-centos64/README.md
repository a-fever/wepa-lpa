...
```
npm install @chilkat/ck-electron3-centos64
```

# usage
```js
var os = require('os');
var chilkat = require('@chilkat/ck-electron3-centos64'); 
...
Visit [Chilkat Electron/Node.js Reference Documentation](http://www.chilkatsoft.com/refdoc/nodejs.asp).

# example code

Visit [Chilkat Electron/Node.js Example Code](http://www.example-code.com/nodejs/default.asp) 
